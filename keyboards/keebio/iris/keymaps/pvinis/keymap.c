...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LR_BASE] = LAYOUT_wrapper(
    _______, _______, _______, _______, GAME   , QWERTY ,                        _______, _______, _______, _______, _______, _______,
  ...
  //                    |    |SPC |    |      |    |    |    |
  //                    `----+---------'      `--------------'
  [LR_GAME] = LAYOUT_wrapper(
    _______, ________________NUMBERS_L__________________,                        ________________NUMBERS_R__________________, QWERTY ,
    _______, _________________QWERTY_L1_________________,                        _________________QWERTY_R1_________________, _______,
    KC_ESC , _________________QWERTY_L2_________________,                        _________________QWERTY_L2_________________, _______,
    _______, _________________QWERTY_L3_________________, _______,      _______, _________________QWERTY_R3_________________, _______,
